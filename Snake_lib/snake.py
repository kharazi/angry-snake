...
class Snake(object):
    ...
    def run(self):
        ...
        # WORM2
        #----------------------------------------------------------------------
        s = worm.Worm(display, int(self.option[13][0]), int(
       ...
       # dg=pygame.font.Font()
        ...
        while True:
            ...
            # play sound
                display.blit(
                    text_player_s_win, (width / 2 - 120, height / 2 - e))
                if tt == 0:
                    self.write_log('\n' + '2player' + ',' + str(self.level) + ',' + s.player_name + ',' + str(
            ...
            if s.joon < 0 or w.score == max_score:
                ...
                self.end_level = True
                if tt == 0:
                    self.write_log('\n' + '2player' + ',' + str(self.level) + ',' + w.player_name + ',' + str(
